                  ...
                  <div className="card-body">
                     <form onSubmit={onFormSubmit}>
                        <div className="input-group mb-3">
                           ...
                           />
                           <div className="invalid-feedback">{user.error_list.first_name}</div>
                        </div>
                        <div className="input-group mb-3">
                           ...
                           />
                           <div className="invalid-feedback">{user.error_list.last_name}</div>
                        </div>
                        <div className="input-group mb-3">
                           ...
                           <input
                              ...
                              value={user.email}
                           />
                           <div className="invalid-feedback">{user.error_list.email}</div>
                        </div>
                        <div className="input-group mb-3">
                           ...
                           <input
                              ...
                              value={user.password}
                           />
                           <div className="invalid-feedback">{user.error_list.password}</div>
                        </div>
                        <div className="input-group mb-3">
                           ...
                           />
                           <div className="invalid-feedback">{user.error_list.confirm_password}</div>
                        </div>
                        <div className="input-group mb-3">
